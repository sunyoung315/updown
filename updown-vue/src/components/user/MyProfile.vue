<template>
    <div>
        <h3>나의 프로필</h3>
        <img v-if="loginUser.img!==null" style="width: 200px;"  :src="'http://localhost:8080/upload/' + loginUser.img" alt="프로필 사진">
        <img v-else style="width: 200px" src="../../asset/icon/profile-user.png" alt="프로필 사진">
